...
class API {
    ...
    func fetch(forBook book: String, and chapter: Int, translation: String) -> AnyPublisher<ChapterResponse, BibleError> {
        
        let urlComponents = createChapterURLComponents(forBook: book, and: chapter, translation: translation)
